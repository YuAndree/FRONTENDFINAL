...
function TeacherEvents() {
  ...
  const fetchEvents = async (sectionId) => {
    try {
      const response = await axios.get(`https:backendfinal-production-2920.up.railway.app/sectionevents/${sectionId}`);
  ...
  useEffect(() => {
    ...
    const fetchTeacherUserId = async () => {
      try {
        const response = await axios.get(`https:backendfinal-production-2920.up.railway.app/sectionstudents/${studentID}`);
  ...
  const registerForEvent = async () => {
    try {
      ...
      const response = await axios.post('https:backendfinal-production-2920.up.railway.app/createStudentEvent', registrationData);
