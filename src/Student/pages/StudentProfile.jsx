...
const StudentProfile = () => {
  ...
  const handleSaveChanges = async () => {
    try {
      ...
      const response = await axios.put(`https:backendfinal-production-2920.up.railway.app/updateStudent/${studentID}`, student);
      setIsEditing(false);
  ...
  const updateProfilePicture = async (event) => {
    ...
    try {
      ...
      const response = await axios.put(`https:backendfinal-production-2920.up.railway.app/addpicture/${studentID}`, formData, {
        headers: {
  ...
  const assignSection = async () => {
    try {
      const response = await axios.post('https:backendfinal-production-2920.up.railway.app/assignStudentToSection', {
  ...
  useEffect(() => {
    const fetchAssignedSections = async () => {
      try {
        const response = await axios.get(`https:backendfinal-production-2920.up.railway.app/studentsection/${student.userid}`);
  ...
  const assignSectionName = async () => {
    try {
      const response = await axios.put(`https:backendfinal-production-2920.up.railway.app/students/${studentID}/section`, null, {
        params: {
