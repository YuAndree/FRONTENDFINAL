...
function AdminAddTeacher() {
    ...
    const [teacherIDExists, setTeacherIDExists] = useState(false);
      const handleChange = async (e) => {
        ...
        if (name === 'email') {
          try {
            const response = await axios.get(`https:backendfinal-production-2920.up.railway.app/checkEmail/${value}`);
          ...
          try {
            const response = await axios.get(`https:backendfinal-production-2920.up.railway.app/checkTeacherID/${value}`);
      ...
      const handleSubmit = async (e) => {
        ...
        if(teacherIDExists){
          ...
          await axios.post('https:backendfinal-production-2920.up.railway.app/createTeacher', formDataToSend);
