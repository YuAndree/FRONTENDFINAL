...
const AdminEventContent = () => {
  ...
  const handleDeleteSection = async (sectionId) => {
    try {
      const response = await axios.delete(`https:backendfinal-production-2920.up.railway.app/deleteeventsection/${selectedEventId}/${sectionId}`);
  ...
  const fetchSections = async () => {
    try {
      const response = await axios.get('https:backendfinal-production-2920.up.railway.app/getAllSections');
  ...
  const handleShowSections = async (eventId) => {
    try {
      const response = await axios.get(`https:backendfinal-production-2920.up.railway.app/sectionevent/${eventId}`);
  ...
  const getByStudentID = async (studentID) => {
    try {
      const response = await axios.get(`https:backendfinal-production-2920.up.railway.app/getByStudentID/${studentID}`);
  ...
  const handleEventClick = async (eventId, eventTitle) => {
    ...
    try {
      const response = await axios.get(`https:backendfinal-production-2920.up.railway.app/getByEventid/${eventId}`);
  ...
  const handleUpdateTime = () => {
    axios.post(`https:backendfinal-production-2920.up.railway.app/${selectedEventId}/${userId}/update-time`)
      .then(response => {
  ...
  const handleDeleteEvent = async () => {
    try {
      await axios.delete(`https:backendfinal-production-2920.up.railway.app/deleteByEventID/${eventToDelete}`);
      await axios.delete(`https:backendfinal-production-2920.up.railway.app/studentdeleteByEventID/${eventToDelete}`);
      await axios.delete(`https:backendfinal-production-2920.up.railway.app/deleteevent/${eventToDelete}`);
  ...
  const handleAddSection = async () => {
    try {
      ...
      const response = await axios.post('https:backendfinal-production-2920.up.railway.app/eventsection', newSection);
  ...
  const handleEditEvent = async () => {
    try {
      const response = await axios.put(`https:backendfinal-production-2920.up.railway.app/updateevent/${selectedEventId}`, editEventData);
