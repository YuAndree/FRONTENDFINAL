...
const AdminArticleContent = () => {
  ...
  const handleConfirmDelete = async () => {
    try {
      await axios.delete(`https:backendfinal-production-2920.up.railway.app/articles/deleteart/${deletedArticleId}`);
  ...
  const handleUpdate = async () => {
    try {
      ...
      await axios.put(
        `https:backendfinal-production-2920.up.railway.app/articles/updateart/${editedArticle.articleID}`,
        updatedArticle
      );
