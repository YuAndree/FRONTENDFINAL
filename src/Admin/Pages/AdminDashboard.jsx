...
useEffect(() => {
  const fetchArticles = async () => {
    try {
      const response = await axios.get('https:backendfinal-production-2920.up.railway.app/articles/getall');
...
const fetchTeacherDetails = (userid) => {
  axios.get(`https:backendfinal-production-2920.up.railway.app/getbyUserid/${userid}`)
    .then(response => {
      setSelectedTeacher(response.data);
      setShowModal(true);
      // Fetch sections for the selected teacher
      axios.get(`https:backendfinal-production-2920.up.railway.app/getbyteacherid/${response.data.teacherID}`)
...
const fetchArticleDetails = (articleID) => {
  axios.get(`https:backendfinal-production-2920.up.railway.app/articles/getart/${articleID}`)
    .then(response => {
...
const fetchEventDetails = (eventID) => {
  axios.get(`https:backendfinal-production-2920.up.railway.app/getByEventid/${eventID}`)
    .then(response => {
