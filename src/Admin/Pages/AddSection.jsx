...
function AddSection() {
    ...
    const handleSubmit = (event) => {
        ...
        axios.post('https:backendfinal-production-2920.up.railway.app/createSection', newSection)
            .then(response => {
    ...
    const handleSubmitAssignTeacher = () => {
        ...
        axios.post('https:backendfinal-production-2920.up.railway.app/assignTeacherToSection', teacherSectionData)
            .then(response => {
