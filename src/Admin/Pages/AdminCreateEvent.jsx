  ...
  function AdminCreateEvent() {
    ...
    const handleSubmit = async (event) => {
      ...
      try {
        ...
        const response = await axios.post(
          'https:backendfinal-production-2920.up.railway.app/events',
          formData,
        );
    ...
    const handleSubmitEvent = async () => {
      try {
        ...
        const response = await axios.post('https:backendfinal-production-2920.up.railway.app/assignSectionToEvent', requestData);
