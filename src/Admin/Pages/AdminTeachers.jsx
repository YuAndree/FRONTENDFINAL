...
function AdminTeachers() {
    ...
    useEffect(() => {
        axios.get('https:backendfinal-production-2920.up.railway.app/getAllSections')
            .then(response => {
    ...
    const handleUpdateTeacher = (sectionId) => {
        if (newTeacherId) {
            axios.put(`https:backendfinal-production-2920.up.railway.app/updateteachersection/${sectionId}/${newTeacherId}`)
                .then(response => {
                    alert("Teacher updated successfully.");
                    // Fetch updated data for the section
                    axios.get(`https:backendfinal-production-2920.up.railway.app/teachersections/${sectionId}`)
    ...
    const deleteTeacher = (userid) => {
        axios.delete(`https:backendfinal-production-2920.up.railway.app/deleteteacher/${userid}`)
            .then(response => {
    ...
    const deleteSection = async (sectionId) => {
        try {
            await axios.delete(`https:backendfinal-production-2920.up.railway.app/deleteteachersection/${sectionId}`);
            await axios.delete(`https:backendfinal-production-2920.up.railway.app/deletestudentsection/${sectionId}`);
            await axios.delete(`https:backendfinal-production-2920.up.railway.app/deleteeventsection/${sectionId}`)
            await axios.delete(`https:backendfinal-production-2920.up.railway.app/deletesection/${sectionId}`);
    ...
    const handleSectionClick = (sectionId) => {
        axios.get(`https:backendfinal-production-2920.up.railway.app/getbySectionid/${sectionId}`)
            .then(response => {
        ...
        axios.get(`https:backendfinal-production-2920.up.railway.app/sections/${sectionId}`)
            .then(response => {
