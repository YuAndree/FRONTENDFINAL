...
const AdminContent = () => {
  ...
  useEffect(() => {
    const fetchAnnouncements = async () => {
      try {
        const response = await axios.get('https:backendfinal-production-2920.up.railway.app/announcements/getall');
  ...
  const handleConfirmDelete = async () => {
    try {
      await axios.delete(`https:backendfinal-production-2920.up.railway.app/announcements/deleteann/${deletedAnnouncementId}`);
  ...
  const handleUpdate = async () => {
    try {
      ...
      await axios.put(
        `https:backendfinal-production-2920.up.railway.app/announcements/updateann/${editedAnnouncement.announcementID}`,
        updatedAnnouncement
      );
